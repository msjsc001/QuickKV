...
1.  **“按原样”提供**
    本软件按“原样”提供，不附带任何形式的明示或暗示的保证，包括但不限于对软件的商业适用性、特定用途适用性和非侵权性的保证。作者不保证软件能满足您的所有需求，也不保证软件的运行不会中断或出现错误。所有条款以软件附带的 [MIT 许可证](https://github.com/msjsc001/QuickKV/blob/main/LICENSE)原文为准。
